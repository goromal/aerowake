...
def main():
    ...
    trans_prev = None
    debug = 3
    logdir = '/home/andrew/Research/aerowake-mit/ros-packages/vision/scripts/test_results'
    ...
    for id in id_vals:
        img = cv2.imread('/home/andrew/Research/aerowake-mit/ros-packages/vision/scripts/test_baselines/%d_[convert](original).png' % id, 0)
