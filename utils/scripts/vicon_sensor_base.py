...
class ViconSensor:
    def __init__(self):
        self.b_psub = rospy.Subscriber("vicon_base_pose", PoseStamped, self.bCallback, queue_size=1)
        self.b_vsub = rospy.Subscriber("vicon_base_twist", TwistStamped, self.bvCallback, queue_size=1)
        self.u_psub = rospy.Subscriber("vicon_uav_pose",  PoseStamped, self.uCallback, queue_size=1)
