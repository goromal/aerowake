...
//  }
    ...
    inline Eigen::Map<Vec3>& t()
    {
        return t_;
    }
    inline const Eigen::Map<Vec3>& t() const
    {
        return t_;
    }
    inline quat::Quat<T>& q()
    {
        return q_;
    }
    inline const quat::Quat<T>& q() const
    {
        return q_;
    }
    inline Eigen::Map<Vec7>& arr()
    {
        return arr_;
    }
    inline const Eigen::Map<Vec7>& arr() const
    {
        return arr_;
    }
    inline void setq(const quat::Quat<T>& q)
    {
        q_ = q;
    }
    inline void sett(const Vec3&t)
    {
        t_ = t;
    }
