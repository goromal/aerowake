...
Att::Att(double _t, const quat::Quatd& _z, const Eigen::Matrix3d& _R)
{
    t = _t;
    z = _z;
    R = _R;
...
#ifdef RELATIVE
Mag::Mag(double _t, const Eigen::Vector3d& _z, const Eigen::Matrix3d& _R)
{
    t = _t;
    z = _z;
    R = _R;
...
Pose::Pose(double _t, const xform::Xformd &_z, const Matrix6d &_R) :
    z(_z),
    R(_R)
{
    t = _t;
